...
/*
	Example:
	[[0,1,2,3],{systemChat str _this},[],1] call SMM_common_fnc_iterate;
*/
...
if (_delayBeforeExec) then {
	[{_this call CBA_fnc_addPerFrameHandler},[_fnc_PFH,_delay,[+_array,_args,_code,_endCode]],_delay] call CBA_fnc_waitAndExecute;
} else {
